...
class LoginPageConsumer extends StatefulWidget {
  @override
  _LoginPageConsumerState createState() => _LoginPageConsumerState();
  LoginPageConsumer();
...
class _LoginPageConsumerState extends State<LoginPageConsumer> {
  ...
  final TextEditingController pointEmailController = new TextEditingController();
  ...
  Future<int> getPointByMail(String pointEmail) async {
    ...
    if(res.statusCode != 200) {
      displayDialog(context, "An Error Occurred", "Point with this email does not exist");
    } else {
      print(res.body);
  ...
  signIn(String id, email) async {
    var pointEmail = pointEmailController.text;
            ...
            child: Container(
                ...
                child: Column(children: <Widget>[
                  ...
                  Container(
                      margin: EdgeInsets.only(right: 10, left: 10),
                      child: TextField(
                        controller: pointEmailController,
                        decoration: InputDecoration(
                            contentPadding: EdgeInsets.only(top: 20, bottom: 20),
                            prefixIcon: Padding(
                              padding: const EdgeInsets.only(left: 20, right: 20),
